...
export const ACHIEVEMENTS = [
  ...
  { id: 'truecel', name: 'Truecel', desc: 'Finish with SMV under 2.5', icon: '😭', check: (p) => p.smv <= 2.5, progress: (p) => p.smv <= 2.5 ? 100 : 0 },
  ...
  { id: 'heartbreaker', name: 'Heartbreaker', desc: 'Secure a dating partner in a run.', icon: '💔', check: (p) => p.hasDatingPartner, progress: (p) => p.hasDatingPartner ? 100 : 0 },
  ...
  { id: 'surgeon_savvy_ach', name: 'Natural Beauty', desc: 'Complete a run with 0 surgeries.', icon: '🌿', check: (p) => p.surgeryBotchedCount === 0, progress: (p) => p.surgeryBotchedCount === 0 ? 100 : 0 },
  ...
  { id: 'rival_slayer', name: 'Rival Slayer', desc: 'Beat your rival at every milestone.', icon: '🥊', check: (p) => p.rivalDefeatedCount >= 4, progress: (p) => Math.min(100, Math.round(p.rivalDefeatedCount / 4 * 100)) },
  { id: 'challenge_complete', name: 'Challenge Mode', desc: 'Complete any challenge run.', icon: '🏅', check: (p) => p.completedChallenge, progress: (p) => p.completedChallenge ? 100 : 0 },
  ...
  { id: 'death_surgery', name: 'Table Fare', desc: 'Die on the operating table.', icon: '🩸', check: (p) => p.isDead && p.surgeryBotchedCount > 0, progress: (p) => (p.isDead && p.surgeryBotchedCount > 0) ? 100 : 0 },
  { id: 'death_overdose', name: 'Overdose', desc: 'Die from substance overdose.', icon: '☠️', check: (p) => p.isDead && p.log.some(l => l.includes('FATAL')), progress: (p) => 0 },
